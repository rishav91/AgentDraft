...
search Agentic Graph Composer's own design docs for lines mentioning a query term.
"""
...
def search_docs(query: str) -> str:
    """Search the docs/ directory for lines mentioning `query`, case-insensitively."""

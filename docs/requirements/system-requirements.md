...
| FR-7.4 | AgentDraft bundles no observability backend | P0 | [OBSERVABILITY.md](../OBSERVABILITY.md) documents self-hosted options (Langfuse, SigNoz, HyperDX, Arize Phoenix) a user may point OTLP at; none is a runtime dependency of `agentdraft` itself |
